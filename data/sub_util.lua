...
util.scale_boxes = function(prototype, scale)
  for _, v in pairs {"collision_box", "selection_box"} do
...
util.has_flag = function(prototype, flag)
  ...
  for _, v in pairs(prototype.flags) do
    if v == flag then
      return true
    end
  end
...
util.prototype = require("data/sub_util/prototype")
